...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN MOSFET_D_PIN           // Set a custom pin for the controller fan
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.2       // (steps or mm) Steps or millimeter distance for each Z babystep
